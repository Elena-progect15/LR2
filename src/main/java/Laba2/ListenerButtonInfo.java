...
public class ListenerButtonInfo implements ActionListener {
    ...
    String text1 = "Кадалова Елена Вадимовна, дата выполнения: 14.04.21, номер зачетной книжки: 19130164 ";  // создается коллекция символов для представления текста
    String text2 = "Саттаров Ян Эдуардович, дата выполнения: 14.04.21, номер зачетной книжки: 19130609 ";   
    String text3 = "Набиев Руслан Ришатович, дата выполнения: 14.04.21, номер зачетной книжки: 19131202 ";
